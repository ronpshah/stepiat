 ...
 */
Drupal.wysiwyg.editor.attach.step = function(context, params, settings) {
  // Attach editor.
 ...
 */
Drupal.wysiwyg.editor.detach.step = function (context, params, trigger) {
...
Drupal.wysiwyg.editor.instance.step = {
