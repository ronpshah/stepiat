...
STEP is a stylized, re-colorable, multi-column theme which uses HTML5
...
STEP 7.x-2.x is a sub-theme of Adaptivetheme, you must download and install
...
* Theme settings and layout: STEP includes lots of theme settings including
  the ability to change the layout and support for mobile devices. Visit the
  theme settings page admin/appearance/settings/step to configure your settings.
...
* Color options: Enable the theme at admin/appearance, and visit
  admin/appearance/settings/step to modify the color scheme if desired.

* Menus: The step theme does not support the hard coded menu defaults. To setup
...
step supports the Superfish module which is a dynamic menu module and enables 
...
STEP is based off of Pixture Reloaded and uses Adaptivetheme. Both created and maintained by:
